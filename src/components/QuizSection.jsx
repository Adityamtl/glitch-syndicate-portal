  ...
  const questions = [
    {
      id: "q1",
      question:
        "A data node is locked. Your console flashes 'ACCESS DENIED'. You:",
      options: [
        {
          value: "hacker",
          label: "Scan for an unsecured port. There's always a back-door.",
        },
        {
          value: "runner",
          label: "Bypass it. Speed is life. Find another route to the payload.",
        },
        {
          value: "enforcer",
          label: "Smash the console. Physical access is still access.",
        },
      ],
    },
    {
      id: "q2",
      question:
        "A rival synth drops a package. A corpo patrol is on the corner. You:",
      options: [
        { value: "runner", label: "Grab it and run. You were built for this." },
        {
          value: "ghost",
          label:
            "Create a distraction. Glitch the patrol's comms and slip by unseen.",
        },
        {
          value: "enforcer",
          label: "Ambush the patrol. Take the package and their gear.",
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "hacker",
          label: "A custom neural deck and a line of pure, untraceable code.",
        },
        {
          value: "enforcer",
          label: "Chromed fists and a plasma shotgun. Keep it personal.",
        },
        {
          value: "ghost",
          label:
            "Optical camo, silenced pistol, and a mono-wire for emergencies.",
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "enforcer",
          label: "Accept. Credits are credits. Business is business.",
        },
        {
          value: "hacker",
          label: 'Refuse. Code is my weapon, not blood. I don\'t do "wetwork".',
        },
        {
          value: "runner",
          label: 'Accept, but "no witnesses" just means "be fast enough."',
        },
      ],
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div className="text-center pt-8" variants={itemVariants}>
            <GlitchButton type="submit">Transmit Answers</GlitchButton>
          </motion.div>
        </motion.form>
      </div>
    </motion.section>
